...
A Redmine 7 theme — a modern SaaS board — cool blue-grey neutrals, roomy rows, a card-like issue list. This is the **rail** variant: navigation lives in a collapsible left rail.
...
Then pick **Atlas** under *Administration → Settings → Display → Theme*.

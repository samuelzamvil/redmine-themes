...
A Redmine 7 theme — built for low light — dark by default with an automatic light variant, periwinkle accent. This is the **rail** variant: navigation lives in a collapsible left rail.
...
```
cp -r umbra /path/to/redmine/themes/
```

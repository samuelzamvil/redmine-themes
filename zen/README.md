...
A Redmine 7 theme — calm and minimal — generous whitespace, hairline rules, a muted teal accent, no zebra striping. This is the **rail** variant: navigation lives in a collapsible left rail.
...
```
cp -r zen /path/to/redmine/themes/
```

Then pick **Zen** under *Administration → Settings → Display → Theme*.
